...
/*
Core Understanding:
    Merge two strings by combining letters from each string one at a time. Remainder of longer string is simply added at the end.
Devising A Plan:
    Create a new string. 
    take the first letter from each string and add it to string while both strings have a letter
    add remaining characters to the end if either of string has letters
Coding it Out:
*/
